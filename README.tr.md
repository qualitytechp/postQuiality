...
QualityTech POS doğrudan işletmenin kendi bilgisayarında çalışır. Siparişler, müşteriler, fişler ve yedekler yerel bir SQLite veritabanında saklanır. Böylece internet bağlantısı olmadan da kasa hizmeti ve mutfak ekranları çalışmaya devam eder. Temel satış noktası işlemleri için barındırılan veya bulut tabanlı bir hesap gerekmez. Google Drive yedekleme, WhatsApp ile fiş gönderme ve bulut bağlantılı raporlama gibi isteğe bağlı entegrasyonlar gerektiğinde etkinleştirilebilir.

## QualityTech POS’yi edinin

En yeni yükleyiciyi [GitHub Releases](/releases) sayfasından indirin veya platformunuzun uygulama mağazasından yükleyin.
...
Node.js yalnızca QualityTech POS geliştirmek için gereklidir; paketlenmiş sürümü çalıştırmak için gerekmez.
...
QualityTech POS aktif olarak geliştirilmektedir ve gerçek kurulumlarda kullanılmaktadır. Müşteri verileri ve yükseltme güvenliği açık veritabanı geçişleri ve kurtarma mekanizmalarıyla dikkatle korunur.
...
- QualityTech POS şema geçişlerini çalıştırmadan önce tarih ve saat içeren otomatik bir yedek oluşturur.
...
QualityTech POS arayüzü İngilizce, İspanyolca, Brezilya Portekizcesi, Fransızca, Farsça, Türkçe, Filipince ve Almanca dillerinde kullanılabilir. Farsça RTL desteği içerir; Türkçe, Filipince ve Almanca soldan sağa yazılır. Arayüz dili, mağazanın ülke ve bölgesel ayarlarından bağımsızdır. Vergi hesaplama kuralları ayrı bir konudur.

QualityTech POS 131 ülke ve 109 para birimi için profiller içerir. Her profil varsayılan para birimi, yerel ayar ve saat dilini belirler; işletme sahibi saat dilini kurulum sırasında veya daha sonra Ayarlar bölümünden değiştirebilir.

## Vergi desteği

QualityTech POS genel bir hesaplama motoru ve imzalı, sürümlenmiş bölgesel vergi paketleri içerir. Manuel vergi kuralları ve oranları da yerel olarak yapılandırılabilir.

> **Uyarı:** QualityTech POS yazılımdır; hukuki veya vergisel danışmanlık değildir. Vergi paketleri ve yapılandırma araçları tek başına yerel mevzuata uyumluluğu belgelemez.

## Geliştirme

QualityTech POS geliştirmek için Node.js 22 veya üzeri gerekir:
...
QualityTech POS, [MIT lisansı](LICENSE) ile lisanslanmış açık kaynaklı bir yazılımdır.
